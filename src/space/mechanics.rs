...
pub mod astrophysics {
    ...
    use crate::space::constants as consts;
...
#[cfg(test)]
mod tests {
    use crate::space::mechanics::astrophysics;
    use crate::space::constants as consts;
